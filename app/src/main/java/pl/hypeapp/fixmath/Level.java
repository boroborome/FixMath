...
//          levelFigures.add("q");
    ...
    private void Level8(){
        ...
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh, "+"});
        this.Figures.add(new String[] {"r", "rf","r", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);
    ...
    private void Level11(){
        ...
        this.Variables.add(new String[]{"8", "1", "1", "1"});
        this.Result.add("11");
        this.Symbols.add(new String[] {"+", "+","+" });
        this.Figures.add(new String[] {"rf", "ok", "ok", "ok"});
        this.ColumnStart.add(0);
        this.LineStart.add(2);
        ...
        this.Variables.add(new String[]{"4", "8", "4", "1", "17"});
        this.Result.add("");
        this.Symbols.add(new String[] {"+", "+", "+"});
        this.Figures.add(new String[] {"s", "rf", "s", "ok", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);


        this.ResultTexts.add("17");
        this.CorrectFigures.add("q");
    ...
    private void Level13(){
        ...
        this.Variables.add(new String[]{"3", "3", "3","4"});
        this.Result.add("5");
        this.Symbols.add(new String[] {"+", "+","-"});
        this.Figures.add(new String[] {"kf", "kf", "kf", "o"});
        this.ColumnStart.add(0);
        this.LineStart.add(3);
        ...
        this.Variables.add(new String[]{"5", "3", "4", "6"});
        this.Result.add("");
        this.Symbols.add(new String[] {"-", "+"});
        this.Figures.add(new String[] {"oz", "kf", "o", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);
    ...
    private void Level18(){
        ...
        this.Variables.add(new String[]{"5", "5", "15"});
        this.Result.add("16");
        this.Symbols.add(new String[] {divideCh, "+" });
        this.Figures.add(new String[] {"o", "o", "k"});
        this.ColumnStart.add(0);
        this.LineStart.add(2);
        ...
        this.Variables.add(new String[]{"5", "4", "4","15","20"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh,divideCh, "+"});
        this.Figures.add(new String[] {"o", "s", "s","k", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);
    ...
    private void Level23(){
        ...
        this.Result.add("64");
        this.Symbols.add(new String[] {multiplerCh,multiplerCh, multiplerCh});
        this.Figures.add(new String[] {"rg", "rg", "s", "s"});
        this.ColumnStart.add(0);
        this.LineStart.add(2);
        ...
        this.Variables.add(new String[]{"7", "2", "2", "4", "28"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh,divideCh, multiplerCh});
        this.Figures.add(new String[] {"oz", "rg", "rg", "s", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);
    ...
    private void Level31(){
        ...
        this.Variables.add(new String[]{"11" , "11", "12", "143"});
        this.Result.add("");
        this.Symbols.add(new String[] {"+",multiplerCh});
        this.Figures.add(new String[] {"kf", "kf","rf", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);

        this.ResultTexts.add("143");
        this.CorrectFigures.add("q");
    ...
    private void Level34(){
        ...
        this.Variables.add(new String[]{"7", "7", "5","5"});
        this.Result.add("59");
        this.Symbols.add(new String[] {multiplerCh,"+","+"});
    ...
    private void Level37(){
        ...
        this.Variables.add(new String[]{"10" , "9", "11", "101"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh, "+"});
        this.Figures.add(new String[] {"kf", "s", "rg", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);

        this.ResultTexts.add("101");
        this.CorrectFigures.add("q");
    ...
    private void Level40(){
        ...
        this.Variables.add(new String[]{"13" , "12", "156"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh});
    ...
    private void Level44(){
        ...
        this.Variables.add(new String[]{"7", "93"});
        this.Result.add("100");
        this.Symbols.add(new String[] {"+"});
        this.Figures.add(new String[] {"rg", "kb"});
        this.ColumnStart.add(0);
        this.LineStart.add(3);

        this.CorrectFigures.add("kb");
        this.ResultTexts.add("93");

        //  93x7=651

        this.Variables.add(new String[]{"93" , "7", "651"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh});
        this.Figures.add(new String[] {"kb", "rg", "q"});
        this.ColumnStart.add(0);
    ...
    private void Level47(){
        ...
        this.Result.add("");
        this.Symbols.add(new String[] {"+", "+", "+"});
        this.Figures.add(new String[] {"rg", "rg", "rg", "k", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);
    ...
    private void Level48(){
        ...
        this.Variables.add(new String[]{"20" , "10", "200", "400"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh, "+"});
    ...
    private void Level53(){
        ...
        this.Result.add("2");
        this.Symbols.add(new String[] {multiplerCh, divideCh});
        this.Figures.add(new String[] {"ok", "k", "ok"});
        this.ColumnStart.add(0);
        this.LineStart.add(2);
        ...
        this.Result.add("96");
        this.Symbols.add(new String[] {multiplerCh,multiplerCh,multiplerCh});
        this.Figures.add(new String[] {"o", "k", "ok", "ok"});
        this.ColumnStart.add(0);
        this.LineStart.add(3);
        ...
        this.Variables.add(new String[]{"8" ,"3", "4", "2", "3"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh,divideCh, divideCh });
        this.Figures.add(new String[] {"rg", "o", "ok", "k", "q"});
        this.ColumnStart.add(0);
    ...
    private void Level54(){
        ...
        this.Variables.add(new String[]{"6" , "5","6","6", "66"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh,"+",multiplerCh});
    ...
    private void Level56(){
        ...
        //  11+11+11+11=44
        this.Variables.add(new String[]{"11", "11", "11", "11"});
        this.Result.add("44");
        this.Symbols.add(new String[] {"+", "+", "+"});
        this.Figures.add(new String[] {"rf", "rf","rf","rf"});
        this.ColumnStart.add(0);
        ...
        this.Variables.add(new String[]{"15", "15", "15", "15"});
        this.Result.add("60");
        this.Symbols.add(new String[] {"+", "+", "+"});
        this.Figures.add(new String[] {"r", "r", "r", "r"});
        this.ColumnStart.add(0);
        ...
        this.Variables.add(new String[]{"17" , "17", "17" , "17"});
        this.Result.add("68");
        this.Symbols.add(new String[] {"+", "+", "+"});
        this.Figures.add(new String[] {"o", "o", "o", "o"});
        this.ColumnStart.add(0);
        ...
        this.Variables.add(new String[]{"19" , "19", "19", "19"});
        this.Result.add("76");
        this.Symbols.add(new String[] {"+", "+", "+"});
        this.Figures.add(new String[] {"ok", "ok", "ok", "ok"});
        this.ColumnStart.add(0);
        ...
        this.ResultTexts.add("19");
        this.CorrectFigures.add("ok");

        //  11+15+17+19=62

        this.Variables.add(new String[]{"11" , "15", "17", "19", "62"});
        this.Result.add("");
        this.Symbols.add(new String[] {"+", "+", "+"});
        this.Figures.add(new String[] {"rf", "r", "o", "ok", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(5);

        this.ResultTexts.add("62");
        this.CorrectFigures.add("q");
    ...
    private void Level57(){
        ...
        // 20x20x20=8000
        this.Variables.add(new String[]{"20", "20", "20"});
        this.Result.add("8000");
        this.Symbols.add(new String[] {multiplerCh,multiplerCh});
        this.Figures.add(new String[] {"kf", "kf", "kf"});
        this.ColumnStart.add(0);
        this.LineStart.add(2);
        ...
        this.Variables.add(new String[]{"20", "20", "20", "300"});
        this.Result.add("7700");
        this.Symbols.add(new String[] {multiplerCh,multiplerCh, "-"});
        this.Figures.add(new String[] {"kf", "kf","kf", "ok"});
        this.ColumnStart.add(0);
        this.LineStart.add(3);

        this.CorrectFigures.add("ok");
        this.ResultTexts.add("300");

        // 300/20=15

        this.Variables.add(new String[]{"300" , "20", "15"});
        this.Result.add("");
        this.Symbols.add(new String[] {divideCh});
        this.Figures.add(new String[] {"ok", "kf", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);
    ...
    private void Level58(){
        ...
        //15x15=225
        this.Variables.add(new String[]{"15", "15"});
        this.Result.add("225");
        this.Symbols.add(new String[] {multiplerCh});
        this.Figures.add(new String[] {"o", "o" });
        this.ColumnStart.add(0);
        ...
        this.Variables.add(new String[]{"15", "15", "25"});
        this.Result.add("9");
        this.Symbols.add(new String[] {multiplerCh, divideCh});
        this.Figures.add(new String[] {"o", "o", "oz"});
        this.ColumnStart.add(0);
        this.LineStart.add(3);

        this.CorrectFigures.add("oz");
        this.ResultTexts.add("25");

        //  15x25=375

        this.Variables.add(new String[]{"15" , "25", "375"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh});
        this.Figures.add(new String[] {"o", "oz","q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);

        this.ResultTexts.add("375");
        this.CorrectFigures.add("q");
    ...
    private void Level59(){
        ...
        this.Variables.add(new String[]{"6", "9", "9"});
        this.Result.add("486");
        this.Symbols.add(new String[] {multiplerCh,multiplerCh});
        this.Figures.add(new String[] {"r", "kb", "kb"});
        this.ColumnStart.add(0);
        this.LineStart.add(3);
        ...
        this.Variables.add(new String[]{"6" , "9", "6", "9"});
        this.Result.add("");
        this.Symbols.add(new String[] {multiplerCh,divideCh});
        this.Figures.add(new String[] {"r", "kb", "r","q"});
        this.ColumnStart.add(0);
    ...
    private void Level60(){
        ...
        //333+333=666
        this.Variables.add(new String[]{"333", "333"});
        this.Result.add("666");
        this.Symbols.add(new String[] {"+"});
        this.Figures.add(new String[] {"s", "s" });
        this.ColumnStart.add(0);
        ...
        this.CorrectFigures.add("s");
        this.ResultTexts.add("333");


        //333x2=666

        this.Variables.add(new String[]{"333", "2"});
        this.Result.add("666");
        this.Symbols.add(new String[] {multiplerCh});
        this.Figures.add(new String[] {"s", "k"});
        this.ColumnStart.add(0);
        this.LineStart.add(3);
        ...
        this.Variables.add(new String[]{"333" , "2", "335"});
        this.Result.add("");
        this.Symbols.add(new String[] {"+"});
        this.Figures.add(new String[] {"s", "k", "q"});
        this.ColumnStart.add(0);
        this.LineStart.add(4);

        this.ResultTexts.add("335");
        this.CorrectFigures.add("q");
